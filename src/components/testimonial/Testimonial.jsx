    ...
    const user = [
        {
            id: 1,
            name: "jhon",
            message: "This LMS helped me go from beginner to confident. The courses are easy to understand, and the concepts are explained very clearly. I now feel confident working on real projects.",
            image: "/men2.jfif"
        },
        {
            id: 2,
        ...
        <>
            ...
            <div className="container mx-auto px-4 my-3">
                <div className="head justify-center justify-items-center p-4">
                    <p className='font-mono hidden sm:block'>Explore Our rating And review by our students</p>
                    <h1 className='text-2xl font-bold font-serif text-blue-800'>Our Testimonial</h1>
                </div>
                <div className="testimonial gap-5 grid md:grid-cols-3">
                    {
                        ...
                        <div class="flex items-center gap-5">
                            <img class="rounded-full  h-20" src={e.image} alt="avatar" />
